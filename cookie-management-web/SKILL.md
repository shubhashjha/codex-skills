---
name: cookie-management-web
description: Basic skill for browser cookies, consent related handling, and session or preference storage on the web. Use when Codex needs a basic starting point for this web development area.
---

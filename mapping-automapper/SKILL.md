---
name: mapping-automapper
description: Basic skill for AutoMapper profiles, object mapping rules, and model transformation in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: webhooks-backend-web
description: Basic skill for webhook endpoints, signature validation, retries, and backend event processing for web systems. Use when Codex needs a basic starting point for this web development area.
---

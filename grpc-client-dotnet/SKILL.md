---
name: grpc-client-dotnet
description: Basic skill for .NET gRPC client generation, channel setup, and remote service consumption. Use when Codex needs a basic starting point for this .NET development area.
---

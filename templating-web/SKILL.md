---
name: templating-web
description: Basic skill for server rendered templates, partials, and HTML generation on web backends. Use when Codex needs a basic starting point for this web development area.
---

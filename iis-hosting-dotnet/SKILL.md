---
name: iis-hosting-dotnet
description: Basic skill for IIS hosting, site configuration, and deployment setup for .NET web applications. Use when Codex needs a basic starting point for this .NET development area.
---

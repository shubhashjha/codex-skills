---
name: video-processing-dotnet
description: Basic skill for video upload, metadata handling, processing workflows, and media related .NET tasks. Use when Codex needs a basic starting point for this .NET development area.
---

# Video Processing .NET

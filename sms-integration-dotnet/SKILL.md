---
name: sms-integration-dotnet
description: Basic skill for SMS provider integration, message dispatch, and notification workflows in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

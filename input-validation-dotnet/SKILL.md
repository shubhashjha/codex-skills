...
description: Basic skill for request validation, boundary checks, and safe input handling in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

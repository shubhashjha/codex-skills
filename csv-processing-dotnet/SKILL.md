---
name: csv-processing-dotnet
description: Basic skill for CSV import, export, parsing, and tabular data workflows in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: elastic-search-dotnet
description: Basic skill for Elasticsearch indexing, querying, and search integration from .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

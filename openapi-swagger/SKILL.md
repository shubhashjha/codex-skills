...
description: Basic skill for Swagger generation, OpenAPI metadata, and API documentation maintenance in .NET projects. Use when Codex needs a basic starting point for this .NET development area.
---

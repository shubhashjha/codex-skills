---
name: billing-subscriptions-dotnet
description: Basic skill for subscription logic, recurring billing support, and account plan workflows in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

# Billing Subscriptions .NET

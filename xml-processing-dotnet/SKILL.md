---
name: xml-processing-dotnet
description: Basic skill for XML parsing, serialization, schema aware handling, and document updates in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

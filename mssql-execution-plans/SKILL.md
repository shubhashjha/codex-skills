---
name: mssql-execution-plans
description: Basic skill for reading SQL Server execution plans and identifying common bottlenecks. Use when Codex needs a basic starting point for this .NET development area.
---

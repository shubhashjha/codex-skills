...
description: Basic skill for Azure Cosmos DB containers, queries, and application integration in .NET codebases. Use when Codex needs a basic starting point for this .NET development area.
---

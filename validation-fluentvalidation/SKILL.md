...
description: Basic skill for FluentValidation rules, request validation, and validation flow design in .NET projects. Use when Codex needs a basic starting point for this .NET development area.
---

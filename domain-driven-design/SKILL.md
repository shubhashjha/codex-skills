...
description: Basic skill for aggregates, entities, value objects, and domain modeling in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

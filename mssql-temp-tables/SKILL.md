---
name: mssql-temp-tables
description: Basic skill for SQL Server temp tables, table variables, and temporary data processing patterns. Use when Codex needs a basic starting point for this .NET development area.
---

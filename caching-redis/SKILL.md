---
name: caching-redis
description: Basic skill for Redis cache integration, distributed caching, and cache key management in .NET services. Use when Codex needs a basic starting point for this .NET development area.
---

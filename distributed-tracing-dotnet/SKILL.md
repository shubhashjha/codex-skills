---
name: distributed-tracing-dotnet
description: Basic skill for tracing instrumentation, correlation, and request flow visibility in distributed .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

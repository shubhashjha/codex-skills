---
name: health-checks-dotnet
description: Basic skill for application health checks, readiness probes, and dependency monitoring in .NET services. Use when Codex needs a basic starting point for this .NET development area.
---

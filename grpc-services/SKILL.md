---
name: grpc-services
description: Basic skill for gRPC contracts, service implementations, and .NET client or server integration. Use when Codex needs a basic starting point for this .NET development area.
---

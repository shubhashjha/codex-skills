...
description: Basic skill for GitHub Actions build pipelines, test automation, and packaging for .NET repositories. Use when Codex needs a basic starting point for this .NET development area.
---

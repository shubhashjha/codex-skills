...
description: Basic skill for RabbitMQ publishing, consuming, acknowledgement handling, and message flow design. Use when Codex needs a basic starting point for this .NET development area.
---

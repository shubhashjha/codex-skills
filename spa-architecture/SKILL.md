...
description: Basic skill for single page application structure, routing, API integration, and maintainable frontend organization. Use when Codex needs a basic starting point for this web development area.
---

---
name: windows-service-dotnet
description: Basic skill for building, hosting, and maintaining Windows Services with .NET worker based applications. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: problem-details-dotnet
description: Basic skill for HTTP problem details responses, error contracts, and API failure formatting in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

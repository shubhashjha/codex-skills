---
name: document-management-dotnet
description: Basic skill for document storage, retrieval, metadata, and workflow handling in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

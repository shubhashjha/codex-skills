...
description: Basic skill for disposable test infrastructure using Testcontainers in .NET test suites. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: cqrs-mediatr
description: Basic skill for command query separation, request handlers, and MediatR based application flows. Use when Codex needs a basic starting point for this .NET development area.
---

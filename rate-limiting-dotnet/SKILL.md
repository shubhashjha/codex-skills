---
name: rate-limiting-dotnet
description: Basic skill for request throttling, quotas, and rate limiting configuration in .NET APIs. Use when Codex needs a basic starting point for this .NET development area.
---

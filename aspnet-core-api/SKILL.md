...
description: Basic skill for building and maintaining ASP.NET Core Web API endpoints, middleware, and request pipelines. Use when Codex needs a basic starting point for this .NET development area.
---

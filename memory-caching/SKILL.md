---
name: memory-caching
description: Basic skill for in memory caching patterns, expiration policies, and safe cache usage in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

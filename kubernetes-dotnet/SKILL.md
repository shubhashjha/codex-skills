...
description: Basic skill for running, configuring, and operating .NET services in Kubernetes environments. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: oauth-web
description: Basic skill for OAuth flows, provider integration, redirect handling, and authorization based web login. Use when Codex needs a basic starting point for this web development area.
---

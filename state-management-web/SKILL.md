---
name: state-management-web
description: Basic skill for frontend state management, local state, shared state, and predictable UI updates. Use when Codex needs a basic starting point for this web development area.
---

---
name: file-processing-dotnet
description: Basic skill for reading, writing, streaming, and validating files in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: odata-dotnet
description: Basic skill for OData endpoints, query support, and API patterns in ASP.NET Core applications. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: azure-key-vault-dotnet
description: Basic skill for Azure Key Vault integration, secret retrieval, and secure configuration in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

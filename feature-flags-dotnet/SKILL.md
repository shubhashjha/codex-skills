...
description: Basic skill for feature flag setup, controlled rollout, and conditional behavior management in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: pipeline-behaviors-dotnet
description: Basic skill for request pipeline behaviors, cross cutting handlers, and MediatR style middleware in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

# Pipeline Behaviors .NET

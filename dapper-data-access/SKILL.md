...
description: Basic skill for Dapper queries, command execution, mapping, and lightweight data access layers. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: identityserver-auth
description: Basic skill for IdentityServer style token flows, client setup, and authentication integration in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

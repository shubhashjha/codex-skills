---
name: image-processing-dotnet
description: Basic skill for image resizing, transformation, validation, and media handling in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

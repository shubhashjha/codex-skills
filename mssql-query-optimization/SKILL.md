---
name: mssql-query-optimization
description: Basic skill for SQL Server query tuning, execution plan review, and reducing slow query patterns. Use when Codex needs a basic starting point for this .NET development area.
---

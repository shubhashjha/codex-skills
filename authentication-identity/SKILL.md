...
description: Basic skill for ASP.NET Core Identity setup, user management, sign in flows, and account features. Use when Codex needs a basic starting point for this .NET development area.
---

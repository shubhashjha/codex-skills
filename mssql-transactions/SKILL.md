...
description: Basic skill for SQL Server transactions, rollback behavior, and safe data consistency workflows. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for integrating .NET applications with common Google Cloud services and configuration patterns. Use when Codex needs a basic starting point for this .NET development area.
---

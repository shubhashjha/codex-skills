...
description: Basic skill for EF Core DbContext setup, mappings, migrations, and common query patterns. Use when Codex needs a basic starting point for this .NET development area.
---

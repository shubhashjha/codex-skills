---
name: terraform-dotnet-infra
description: Basic skill for Terraform based infrastructure that supports .NET service deployments and environments. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for SQL Server Agent jobs, schedules, and recurring database maintenance tasks. Use when Codex needs a basic starting point for this .NET development area.
---

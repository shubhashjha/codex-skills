...
description: Basic skill for Roslyn source generators, compile time code generation, and analyzer driven patterns in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: pinia-web
description: Basic skill for Pinia stores, shared state, and maintainable Vue application state management. Use when Codex needs a basic starting point for this web development area.
---

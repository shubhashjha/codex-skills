...
description: Basic skill for SQL Server access patterns, performance checks, and database friendly .NET queries. Use when Codex needs a basic starting point for this .NET development area.
---

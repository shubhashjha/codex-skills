---
name: mediator-pattern-dotnet
description: Basic skill for mediator based decoupling, request orchestration, and structured application flows in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

# Mediator Pattern .NET

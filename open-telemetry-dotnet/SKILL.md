---
name: open-telemetry-dotnet
description: Basic skill for OpenTelemetry metrics, traces, logs, and observability setup in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

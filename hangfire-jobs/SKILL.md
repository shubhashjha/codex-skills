---
name: hangfire-jobs
description: Basic skill for Hangfire recurring jobs, background job processing, retries, and dashboard usage. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: websockets-dotnet
description: Basic skill for WebSocket connections, message loops, and persistent realtime channels in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

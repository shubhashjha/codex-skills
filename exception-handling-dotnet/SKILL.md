---
name: exception-handling-dotnet
description: Basic skill for exception handling policies, error translation, and reliable failure behavior in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

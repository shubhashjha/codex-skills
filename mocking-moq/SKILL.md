---
name: mocking-moq
description: Basic skill for Moq based test doubles, behavior setup, and interaction verification in unit tests. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: mssql-table-design
description: Basic skill for SQL Server table design, keys, constraints, and practical relational modeling. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: benchmarkdotnet-performance
description: Basic skill for BenchmarkDotNet benchmarks, measurement setup, and performance comparison work. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: visual-regression-web
description: Basic skill for visual regression checks and UI change detection in web applications. Use when Codex needs a basic starting point for this web development area.
---

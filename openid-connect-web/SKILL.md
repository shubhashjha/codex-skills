---
name: openid-connect-web
description: Basic skill for OpenID Connect login, identity flows, and secure web application authentication. Use when Codex needs a basic starting point for this web development area.
---

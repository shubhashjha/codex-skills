---
name: data-migration-dotnet
description: Basic skill for application data migrations, transformation routines, and safe migration execution in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: repository-pattern-dotnet
description: Basic skill for repository abstractions, persistence boundaries, and data access structure in .NET solutions. Use when Codex needs a basic starting point for this .NET development area.
---

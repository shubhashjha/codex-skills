---
name: worker-service
description: Basic skill for .NET worker services, service hosting, startup wiring, and background processing. Use when Codex needs a basic starting point for this .NET development area.
---

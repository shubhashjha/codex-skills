...
description: Basic skill for creating, updating, and calling SQL Server stored procedures from application code. Use when Codex needs a basic starting point for this .NET development area.
---

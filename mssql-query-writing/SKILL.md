---
name: mssql-query-writing
description: Basic skill for writing SELECT, JOIN, GROUP BY, filtering, and readable SQL Server queries. Use when Codex needs a basic starting point for this .NET development area.
---

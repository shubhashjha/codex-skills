---
name: blazor-server
description: Basic skill for Blazor Server components, state handling, and server connected UI workflows. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: secure-coding-dotnet
description: Basic skill for secure coding practices, secret handling, validation, and common .NET security concerns. Use when Codex needs a basic starting point for this .NET development area.
---

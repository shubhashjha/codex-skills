---
name: postgresql-with-dotnet
description: Basic skill for PostgreSQL connectivity, mapping, and application level patterns in .NET codebases. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for xUnit test structure, assertions, and isolated unit testing in .NET projects. Use when Codex needs a basic starting point for this .NET development area.
---

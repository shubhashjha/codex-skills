---
name: refactoring-legacy-dotnet
description: Basic skill for safely improving legacy .NET codebases, reducing risk, and preserving behavior. Use when Codex needs a basic starting point for this .NET development area.
---

# Refactoring Legacy .NET

...
description: Basic skill for SignalR hubs, connection handling, and realtime server to client messaging. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for role checks, policy based authorization, claims evaluation, and protected endpoints. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: mssql-indexing
description: Basic skill for SQL Server indexes, index selection, and common query performance improvements. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: smtp-mailkit-dotnet
description: Basic skill for MailKit based SMTP email sending and message composition in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

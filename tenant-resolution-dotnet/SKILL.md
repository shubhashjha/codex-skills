---
name: tenant-resolution-dotnet
description: Basic skill for tenant resolution, context propagation, and tenant aware request flows in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

# Tenant Resolution .NET

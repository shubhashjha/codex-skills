---
name: node-auth-web
description: Basic skill for Node based web authentication, sessions, tokens, and login related backend features. Use when Codex needs a basic starting point for this web development area.
---

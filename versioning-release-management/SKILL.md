...
description: Basic skill for semantic versioning, release notes, tagging, and controlled delivery of .NET software. Use when Codex needs a basic starting point for this .NET development area.
---

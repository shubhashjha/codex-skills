...
description: Basic skill for AWS Lambda handlers, packaging, and serverless .NET application workflows. Use when Codex needs a basic starting point for this .NET development area.
---

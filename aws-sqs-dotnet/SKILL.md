---
name: aws-sqs-dotnet
description: Basic skill for AWS SQS publishing, consuming, and queue based processing in .NET services. Use when Codex needs a basic starting point for this .NET development area.
---

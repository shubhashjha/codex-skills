---
name: local-storage-web
description: Basic skill for local storage, session storage, and lightweight browser persistence in web apps. Use when Codex needs a basic starting point for this web development area.
---

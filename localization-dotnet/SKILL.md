---
name: localization-dotnet
description: Basic skill for localization, resource files, culture handling, and multilingual .NET application support. Use when Codex needs a basic starting point for this .NET development area.
---

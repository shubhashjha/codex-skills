---
name: distributed-locking-dotnet
description: Basic skill for distributed locking, coordination, and safe multi instance processing in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

# Distributed Locking .NET

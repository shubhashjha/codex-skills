---
name: http-clients-dotnet
description: Basic skill for outbound HTTP integrations, client factories, resilience, and serialization in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

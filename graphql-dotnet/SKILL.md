---
name: graphql-dotnet
description: Basic skill for GraphQL schema setup, resolvers, and API integration in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: pdf-generation-dotnet
description: Basic skill for PDF document creation, templating, and export workflows in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

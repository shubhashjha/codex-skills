---
name: soft-delete-dotnet
description: Basic skill for soft delete patterns, restoration workflows, and filtered query behavior in .NET data models. Use when Codex needs a basic starting point for this .NET development area.
---

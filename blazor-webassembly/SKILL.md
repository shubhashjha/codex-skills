...
description: Basic skill for Blazor WebAssembly components, client side state, and browser based app structure. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for layered project structure, separation of concerns, and maintainable .NET solution layout. Use when Codex needs a basic starting point for this .NET development area.
---

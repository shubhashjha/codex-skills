---
name: dashboard-backend-dotnet
description: Basic skill for backend services that support dashboards, metrics, summaries, and reporting APIs. Use when Codex needs a basic starting point for this .NET development area.
---

# Dashboard Backend .NET

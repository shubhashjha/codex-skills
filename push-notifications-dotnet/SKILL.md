---
name: push-notifications-dotnet
description: Basic skill for push notification integration and message delivery workflows from .NET services. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: mssql-backup-restore
description: Basic skill for SQL Server backup, restore, and routine recovery related workflows. Use when Codex needs a basic starting point for this .NET development area.
---

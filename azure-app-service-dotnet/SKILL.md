---
name: azure-app-service-dotnet
description: Basic skill for deploying and configuring .NET applications on Azure App Service. Use when Codex needs a basic starting point for this .NET development area.
---

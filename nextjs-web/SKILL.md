---
name: nextjs-web
description: Basic skill for Next.js routing, rendering modes, API routes, and production web application structure. Use when Codex needs a basic starting point for this web development area.
---

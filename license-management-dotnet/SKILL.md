---
name: license-management-dotnet
description: Basic skill for product license checks, entitlement workflows, and license related backend logic in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

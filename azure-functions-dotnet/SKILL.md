...
description: Basic skill for Azure Functions triggers, bindings, configuration, and serverless .NET workflows. Use when Codex needs a basic starting point for this .NET development area.
---

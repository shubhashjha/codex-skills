---
name: mssql-locking-blocking
description: Basic skill for SQL Server locking, blocking, deadlock analysis, and concurrency related fixes. Use when Codex needs a basic starting point for this .NET development area.
---

# MSSQL Locking Blocking

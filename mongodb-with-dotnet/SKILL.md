---
name: mongodb-with-dotnet
description: Basic skill for MongoDB collections, document mapping, and repository style data access in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

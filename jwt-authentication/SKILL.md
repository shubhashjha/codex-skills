...
description: Basic skill for JWT token issuing, bearer authentication, and secured API request handling. Use when Codex needs a basic starting point for this .NET development area.
---

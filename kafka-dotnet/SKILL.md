---
name: kafka-dotnet
description: Basic skill for Kafka producers, consumers, serialization, and event streaming patterns in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

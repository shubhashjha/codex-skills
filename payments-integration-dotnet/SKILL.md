---
name: payments-integration-dotnet
description: Basic skill for payment provider integration, transaction flows, and safe billing related .NET code changes. Use when Codex needs a basic starting point for this .NET development area.
---

# Payments Integration .NET

---
name: idempotency-dotnet
description: Basic skill for idempotent APIs, duplicate request prevention, and safe retry behavior in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for Polly retries, circuit breakers, timeouts, and resilience configuration in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

---
name: schema-migrations-dotnet
description: Basic skill for database schema migration planning and execution in .NET based applications. Use when Codex needs a basic starting point for this .NET development area.
---

# Schema Migrations .NET

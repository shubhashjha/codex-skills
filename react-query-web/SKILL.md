---
name: react-query-web
description: Basic skill for server state fetching, caching, and async data workflows in React web applications. Use when Codex needs a basic starting point for this web development area.
---

---
name: session-state-dotnet
description: Basic skill for session state configuration, lifecycle handling, and server side session use in .NET apps. Use when Codex needs a basic starting point for this .NET development area.
---

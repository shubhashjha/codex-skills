...
description: Basic skill for appsettings files, options binding, environment configuration, and secret usage patterns. Use when Codex needs a basic starting point for this .NET development area.
---

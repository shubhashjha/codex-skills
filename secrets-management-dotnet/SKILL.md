...
description: Basic skill for secure secret storage, retrieval, and environment specific secret handling in .NET apps. Use when Codex needs a basic starting point for this .NET development area.
---

# Secrets Management .NET

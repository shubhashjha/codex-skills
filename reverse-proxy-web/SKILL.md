...
description: Basic skill for reverse proxy configuration, routing, and deployment patterns for web applications. Use when Codex needs a basic starting point for this web development area.
---

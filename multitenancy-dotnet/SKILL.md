...
description: Basic skill for tenant isolation, tenant aware services, and shared platform patterns in .NET systems. Use when Codex needs a basic starting point for this .NET development area.
---

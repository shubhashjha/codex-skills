...
description: Basic skill for specification pattern usage, query encapsulation, and reusable filtering logic in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

# Specification Pattern .NET

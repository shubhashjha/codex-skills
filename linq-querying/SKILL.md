---
name: linq-querying
description: Basic skill for LINQ filtering, projection, grouping, and readable query composition in .NET code. Use when Codex needs a basic starting point for this .NET development area.
---

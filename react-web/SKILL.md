---
name: react-web
description: Basic skill for React components, props, state, event handling, and maintainable frontend application code. Use when Codex needs a basic starting point for this web development area.
---

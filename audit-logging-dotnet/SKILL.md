---
name: audit-logging-dotnet
description: Basic skill for audit trails, change history, and compliance focused event recording in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

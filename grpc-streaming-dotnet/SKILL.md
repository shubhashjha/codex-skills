---
name: grpc-streaming-dotnet
description: Basic skill for streaming gRPC endpoints, client streams, and realtime data exchange in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

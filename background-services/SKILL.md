...
description: Basic skill for hosted services, scheduled loops, graceful shutdown, and long running background work. Use when Codex needs a basic starting point for this .NET development area.
---

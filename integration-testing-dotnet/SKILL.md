...
description: Basic skill for end to end and integration test setup for APIs, services, and data access code. Use when Codex needs a basic starting point for this .NET development area.
---

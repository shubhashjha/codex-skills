---
name: excel-processing-dotnet
description: Basic skill for spreadsheet import, export, and tabular data handling in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---

# Excel Processing .NET

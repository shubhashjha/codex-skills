...
description: Basic skill for Azure DevOps pipelines, build definitions, and release automation for .NET work. Use when Codex needs a basic starting point for this .NET development area.
---

...
description: Basic skill for Azure Service Bus queues, topics, handlers, and messaging patterns in .NET. Use when Codex needs a basic starting point for this .NET development area.
---

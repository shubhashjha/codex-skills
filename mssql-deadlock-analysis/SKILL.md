---
name: mssql-deadlock-analysis
description: Basic skill for investigating SQL Server deadlocks and reducing deadlock prone query patterns. Use when Codex needs a basic starting point for this .NET development area.
---

# MSSQL Deadlock Analysis

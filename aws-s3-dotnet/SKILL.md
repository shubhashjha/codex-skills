---
name: aws-s3-dotnet
description: Basic skill for AWS S3 file storage, upload or download flows, and .NET integration patterns. Use when Codex needs a basic starting point for this .NET development area.
---

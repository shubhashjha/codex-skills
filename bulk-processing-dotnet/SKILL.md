---
name: bulk-processing-dotnet
description: Basic skill for batch jobs, large volume imports, and bulk update workflows in .NET applications. Use when Codex needs a basic starting point for this .NET development area.
---
